...
import { Heart, PlusCircle, Armchair } from 'lucide-react'; // Using Armchair for seating
      ...
      {!weddingData ? (
        ...
        <>
          ...
          <Card className="shadow-lg">
            <CardHeader>
              <CardTitle>Venue Layout & Guest Seating</CardTitle>
              <CardDescription>
                Organize tables, assign guests, and ensure everyone has a great seat.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Seating arrangement features will be available here soon.
              </p>
              <div className="mt-6 p-6 bg-secondary rounded-md text-center">
                <p className="font-medium text-secondary-foreground">Interactive seating planner coming soon!</p>
              </div>
            </CardContent>
          </Card>
        </>

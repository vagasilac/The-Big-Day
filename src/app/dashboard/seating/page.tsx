...
import { Stage, Layer, Rect as KonvaRect, Circle as KonvaCircle, Group, Text, Line } from 'react-konva';
    ...
    return (
      <div className="flex flex-col gap-6 md:gap-8 h-[calc(100vh-10rem)]">
        <div className="flex items-center justify-between flex-shrink-0">
            ...
            <Button variant="outline" onClick={handleClearSelection} disabled={isSavingSelection}> {isSavingSelection && <Loader2 className="mr-2 h-4 w-4 animate-spin" />} Change Layout </Button>
        </div>

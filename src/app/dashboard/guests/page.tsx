        ...
        <>
          <div className="flex items-center gap-3">
            ...
            <div>
                ...
                Manage your wedding guests and their details.
                </p>
            </div>
          </div>
          ...
          <Card className="shadow-lg">
            <CardHeader>
              ...
              <CardDescription>
                Add, edit, and organize your guest list.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Guest list management features will be available here soon.
              </p>
              <div className="mt-6 p-6 bg-secondary rounded-md text-center">
                <p className="font-medium text-secondary-foreground">Guest list features coming soon!</p>
              </div>
            </CardContent>
          </Card>
        </>

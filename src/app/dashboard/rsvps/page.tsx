...
import { Heart, PlusCircle, ListChecks } from 'lucide-react';
      ...
      {!weddingData ? (
        <Card className="border-dashed border-2 p-8 text-center shadow-sm">
          ...
          <CardDescription className="text-muted-foreground mb-6 max-w-md mx-auto">
            Please create your wedding site first to manage RSVPs.
          </CardDescription>
          <Button asChild>
        ...
        <>
          <div className="flex items-center gap-3">
            ...
            <div>
                <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-foreground">RSVP Management</h1>
                <p className="text-muted-foreground mt-1">
                Track guest responses and manage attendance.
                </p>
            </div>
          </div>
          ...
          <Card className="shadow-lg">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                RSVP tracking features will be available here soon.
              </p>
              <div className="mt-6 p-6 bg-secondary rounded-md text-center">
                <p className="font-medium text-secondary-foreground">RSVP features coming soon!</p>
              </div>
            </CardContent>
          </Card>
        </>
